...
/**
 * An extension of the <code>JDialog</code> with built-in support for OK/CANCEL/CLOSE buttons.
 * 
...
public class BaseDialog extends JDialog {
	...
	/**
	 * Used to set the mode of the dialog to OK/CANCEL. When in this mode, OK and Cancel buttons are automatically added to the dialog.
	 */
	public final static int OK_CANCEL_DIALOG = 0;
	
	/**
	 * Used to set the mode of the dialog to OK/CANCEL. When in this mode, a Close button is automatically added to the dialog.
	 */
	...
	/**
	 * Gets the BannerPanel displayed in this dialog. The BannerPanel can be made invisible by calling <code>getBanner().setVisible(false);</code> if it is not needed.
	 * 
	 * @return
	 * @see BannerPanel
	 */
	...
	/**
	 * Sets the mode of this dialog. Default mode is {@link BaseDialog#OK_CANCEL_DIALOG}
	 * 
	 * @param mode
	 *            {@link BaseDialog#OK_CANCEL_DIALOG}or {@link BaseDialog#CLOSE_DIALOG}
	 */
