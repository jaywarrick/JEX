...
public class PropertyEditorRegistry implements PropertyEditorFactory {
	 ...
	 * <ul>
	 * <li>if propertyDescriptor.getPropertyEditorClass() returns a valid value, it is returned, else,
	 * <li>if an editor was registered with {@link #registerEditor(Property, PropertyEditor)}, it is returned, else</li>
	 * <li>if an editor class was registered with {@link #registerEditor(Property, Class)}, it is returned, else
	 * <li>
	 * <li>look for editor for the property type using {@link #getEditor(Class)} .it is returned, else</li>
	 ...
	 * <ul>
	 * <li>if an editor was registered with {@link #registerEditor(Class, PropertyEditor)}, it is returned, else</li>
	 * <li>if an editor class was registered with {@link #registerEditor(Class, Class)}, it is returned, else
	 * <li>
	...
	/**
	 * Adds default editors. This method is called by the constructor but may be called later to reset any customizations made through the <code>registerEditor</code> methods. <b>Note: if overriden, <code>super.registerDefaults()</code> must be
