 ...
 * 
 */
public class JEX_Migration_AnalyzePointSourceMigartion extends ExperimentalDataCrunch {
	...
	{
		String result = "7. Analyze Point Source Tracks";
		return result;
	}
	...
	{
		defaultOutputNames = new TypeName[13];
		...
		defaultOutputNames[8] = new TypeName(VALUE, "Percent forward moving cells");
		
		defaultOutputNames[9] = new TypeName(IMAGE, "Velocity Histogram");
		defaultOutputNames[10] = new TypeName(IMAGE, "Angle Histogram");
		defaultOutputNames[11] = new TypeName(VALUE, "Value table");

		defaultOutputNames[12] = new TypeName(VALUE, "Mean chemo-velocity");
