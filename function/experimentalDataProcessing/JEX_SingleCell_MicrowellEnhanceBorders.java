 ...
 * 
 */
public class JEX_SingleCell_MicrowellEnhanceBorders extends ExperimentalDataCrunch {
	...
	{
		String result = "Microwell Enhance Borders";
		return result;
	}
	...
	{
		String result = "Subtract background, subtract median intensity (background), and invert image to make microwell borders brighter.";
		return result;
	}
	...
	public TypeName[] getOutputs()
	{
		...
		this.defaultOutputNames[0] = new TypeName(IMAGE, "Enhanced Image");
	...
	public ParameterSet requiredParameters()
	{
		...
		Parameter p6 = new Parameter("Output Bit Depth", "Depth of the outputted image", Parameter.DROPDOWN, new String[] { "8", "16", "32" }, 2);
