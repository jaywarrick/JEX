 ...
 * 
 */
public class JEX_Migration_FindMax extends ExperimentalDataCrunch {
	...
	public ParameterSet requiredParameters()
	{
		...
		Parameter p3 = new Parameter("Mode", "Which type of calculation to perform?", Parameter.DROPDOWN, new String[] { "Threshold", "Fixed number" }, 1);
		...
		Parameter p6 = new Parameter("Loop order", "Reverse looping order?", Parameter.DROPDOWN, new String[] { "Normal", "Reverse" }, 1);
