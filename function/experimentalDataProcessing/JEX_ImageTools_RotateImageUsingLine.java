 ...
 * 
 */
public class JEX_ImageTools_RotateImageUsingLine extends ExperimentalDataCrunch {
	
	public JEX_ImageTools_RotateImageUsingLine()
	{}
	...
	{
		Parameter p0 = new Parameter("Image Orientation", "Rotate to correct an image to either vertical or horizontal", Parameter.DROPDOWN, new String[] { "Vertical", "Horizontal" }, 1);
		Parameter p1 = new Parameter("Interpolation Method", "Reassigns Pixel Intensities Based on This Method", Parameter.DROPDOWN, new String[] { "Bilinear", "Bicubic", "Nearest Neighbor" }, 0);
		// Parameter p2 = new
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		if(interp.equals("Bilenar"))
			interpMode = ImageProcessor.BILINEAR;
		else if(interp.equals("Bicubic"))
			interpMode = ImageProcessor.BICUBIC;
