 ...
 * 
 */
public class JEX_OscillatoryAdhesionCompileResults extends ExperimentalDataCrunch {
	
	public JEX_OscillatoryAdhesionCompileResults()
	{}
	...
	{
		String result = "Oscillatory Adhesion Compile Results";
		return result;
	}
	...
	public TypeName[] getInputNames()
	{
		...
		inputNames[0] = new TypeName(VALUE, "Curve Fit Results");
		return inputNames;
	}
	...
	public TypeName[] getOutputs()
	{
		...
		defaultOutputNames[0] = new TypeName(FILE, "Compiled Results");
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		compiledMap.put("Measurement", "Tau50");
		compiledData.put(compiledMap.copy(), fitResults.get(compiledMap));
		compiledMap.put("Measurement", "Sigma");
		compiledData.put(compiledMap.copy(), fitResults.get(compiledMap));
		compiledMap.put("Measurement", "Ymin");
		compiledData.put(compiledMap.copy(), fitResults.get(compiledMap));
