 ...
 * 
 */
public class JEX_Test_ROItest extends ExperimentalDataCrunch {
	...
	public TypeName[] getOutputs()
	{
		...
		defaultOutputNames[0] = new TypeName(new Type(JEXData.ROI,"test flavor"), "ROI");
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		JEXData roiData = RoiWriter.makeRoiObject("MyFavoriteROI","test roi", roi);
		realOutputs.add(roiData);
