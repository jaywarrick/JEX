 ...
 * 
 */
public class IJ2Plugin extends ExperimentalDataCrunch {
	...
	public void setCommand(CommandInfo command)
	{
		...
		if(command.getMenuPath().size() == 0)
		{
			this.toolbox = "ImageJ2";
		}
		else
		{
			this.toolbox = "ImageJ2/" + command.getMenuPath().get(0).getName();
		}
