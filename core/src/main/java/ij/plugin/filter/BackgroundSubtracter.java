...
public class BackgroundSubtracter implements ExtendedPlugInFilter, DialogListener {
	...
	private static double radius = 50; // default
	// rolling
	// ball
	// radius
	...
	// color
	// channel
	private static boolean createBackground; // don't
	// subtract
	// background
	// (e.g.,
	// for
	...
	// before
	// subtracting)
	private static boolean useParaboloid; // use
	// "Sliding Paraboloid"
	// instead
	// of
	// rolling
	// ball
	// algorithm
	private static boolean doPresmooth = true; // smoothen
	// the
	// image
	// before
	// creating
		...
		for (int channelNumber = 0; channelNumber < ip.getNChannels(); channelNumber++)
		{
			...
			{ // subtract the background now
				...
				{ // here ip and fp are the same (bgPixels will be output)
					float[] snapshotPixels = (float[]) fp.getSnapshotPixels(); // original
					// data
					// in
					// the
					// snapshot
