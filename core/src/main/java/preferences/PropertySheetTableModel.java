...
public class PropertySheetTableModel extends AbstractTableModel implements PropertyChangeListener, PropertySheet, ObjectTableModel {
	...
	/**
	 * Get the current mode, either {@link PropertySheet#VIEW_AS_CATEGORIES} or {@link PropertySheet#VIEW_AS_FLAT_LIST}.
	 */
	public int getMode()
	{
		return mode;
	...
	/**
	 * Retrieve the value at the specified row and column location. When the row contains a category or the column is {@link #NAME_COLUMN}, an {@link Item} object will be returned. If the row is a property and the column is {@link #VALUE_COLUMN}, the
	 * value of the property will be returned.
	 * 
	...
	/**
	 * Sets the value at the specified row and column. This will have no effect unless the row is a property and the column is {@link #VALUE_COLUMN}.
	 * 
	 ...
	 * @param parent
	 *            the {@link Item} parent of these properties, null if none
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	...
	/**
	 * The default comparator for Properties. Used if no other comparator is defined.
	 */
	@SuppressWarnings("rawtypes")
