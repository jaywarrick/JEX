...
public class ResourceManager {
	...
	/**
	 * Gets the ResourceManager associated with <code>clazz</code>. It looks for a ResourceBundle named against the class name plus the string "RB". For example, for the com.mypackage.Main, the ResourceBundle com.mypackage.MainRB will be looked up.
	 * 
	 * @param clazz
	...
	/**
	 * Gets the default ResourceManager. This is equivalent to <code>all(ResourceManager.class)</code>. It returns the ResourceManager named "AllRB" located in the same package ResourceManager class (i.e com.l2fprod.common.util.AllRB).
	 * 
	...
	/**
	 * Resolves any references to a resource bundle contained in <code>rbAndProperty</code>. To reference a resource bundle inside a property use <code>${com.package.FileRB:key}</code>, this will look for <code>key</code> in the ResourceBundle
	...
	/**
	 * Same as {@link #resolve(String)} but once the value as been resolved, a MessageFormatter is applied with the given <code>args</code>.
	 * 
	 * @param rbAndProperty
	 * @param args
	...
	/**
	 * Gets the String associated with <code>key</code> after having resolved any nested keys ({@link #resolve(String)}).
	 * 
	 * @param key
	 *            the key to lookup
	...
	/**
	 * Gets the String associated with <code>key</code> after having resolved any nested keys ({@link #resolve(String)}) and applied a formatter using the given <code>args</code>.
	 * 
	 * @param key
	 *            the key to lookup
	 * @param args
