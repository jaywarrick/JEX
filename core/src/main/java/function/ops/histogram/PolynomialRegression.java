 ...
 *
 * Borrowed from: https://algs4.cs.princeton.edu/14analysis/PolynomialRegression.java
 * from §1.4 Analysis of Algorithms (https://algs4.cs.princeton.edu/14analysis/).
 * 
 ******************************************************************************/
...
public class PolynomialRegression implements Comparable<PolynomialRegression> {
  ...
  /**
    ...
    public PolynomialRegression(double[] x, int[] y, int degree)
    {
    	this(x, getAsDouble(y), degree, "n");
    }
    
    private static double[] getAsDouble(int[] y)
    {
