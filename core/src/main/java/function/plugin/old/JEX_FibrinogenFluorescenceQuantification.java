 ...
 * 
 */
public class JEX_FibrinogenFluorescenceQuantification extends JEXCrunchable {
...
class FibrinogenFluorescenceCounter implements GraphicalCrunchingEnabling, ImagePanelInteractor {
	...
	FibrinogenFluorescenceCounter(JEXEntry entry, JEXData imset, TypeName[] outputNames, ParameterSet parameters)
	{
