 ...
 * 
 */
public class JEX_3D_LiveDead_SingleCell extends JEXCrunchable {
...
class LiveDeadCellFinder implements GraphicalCrunchingEnabling, ImagePanelInteractor {
	...
	LiveDeadCellFinder(JEXEntry entry, JEXData day1_liveImset, JEXData day1_deadImset, JEXData rectangle, TypeName[] outputNames, ParameterSet parameters)
	{
	...
	private void analyze()
	{
		...
		{
			if(isPointCloseToPointInList(doubleRadius, p, day1_deadPoints))
				continue;
			validatedLive.add(p);
		}
