 ...
 * 
 */
public class JEX_SaveDatabase extends JEXCrunchable {
	...
	{
		Parameter p0 = new Parameter("Dummy Parameter", "Parameter to indicate that function was successfully selected.", Parameter.DROPDOWN, new String[] { "true" }, 0);
		// Parameter p1 = new
	...
	public boolean run(JEXEntry entry, HashMap<String,JEXData> inputs)
	{
		...
		Logs.log("Function Save Time-stamp: " + getDateTime(), 0, this);
