...
public class ImageStackStitcherFixedGrid extends JEXPlugin {
	...
	@ParameterMarker(uiOrder=9, name="Intensity Multiplier", description="How much to multiply the image size (0.5 reduces image to half its original size)", ui=MarkerConstants.UI_TEXTFIELD, defaultText="1.0")
	double multiplier;
