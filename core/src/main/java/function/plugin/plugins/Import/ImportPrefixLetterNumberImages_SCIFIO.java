...
public class ImportPrefixLetterNumberImages_SCIFIO extends JEXPlugin {
	...
	public boolean run(JEXEntry optionalEntry) {
		...
		// DO something
		Pair<JEXData, JEXData> imagesAndMetaData = io.importFiles(newFileList, this.dimSeparator, this.valueSeparator, this.fileExtension, this.imRows, this.imCols, binning, binMethod, "ImRow", "ImCol", this.transferNames, this);
