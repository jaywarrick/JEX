...
public class ImportImagesFromFileObject_SCIFIO extends JEXPlugin {
	...
	public boolean run(JEXEntry optionalEntry) {
		...
		// DO something
		Pair<JEXData, JEXData> imagesAndMetaData = io.importFiles(pendingImageFiles, this.dimSeparator, this.valueSeparator, fileExtension, this.imRows, this.imCols, binning, binMethod, "ImRow", "ImCol", this.transferNames, this);
