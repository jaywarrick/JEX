...
*/
public class FFT_Filter implements Measurements {
...
//	private int stackSize = 1;	
	...
	public double filterLargeDia = 40.0;
	public double  filterSmallDia = 3.0;
	public int choiceIndex = 0;
	public String[] choices = {"None","Horizontal","Vertical"};
	public String choiceDia = choices[0];
	public double toleranceDia = 5.0;
	public boolean doScalingDia = true;
	...
	/**
	 * Process the ip 'void' style, editing ip in place.
	 * 
	 * CAREFUL!! The returned image is actually the fft filter.
	 *  
	 * @param ip (edited in place)
	 * @return ImagePlus of the fft filter used if 'displayFilter' is set to true
	 */
	public ImagePlus filter(ImageProcessor ip) {
		
		// Remember the bitdepth of the image
		...
		ImagePlus retFilter = filterLargeSmall(fht, filterLarge, filterSmall, choiceIndex, sharpness);
		...
		ip2 = fht.crop();
		if (doScaling) {
			ImagePlus imp2 = new ImagePlus("Image-filtered", ip2);
	...
	*/
	ImagePlus filterLargeSmall(ImageProcessor ip, double filterLarge, double filterSmall, int stripesHorVert, double scaleStripes) {
