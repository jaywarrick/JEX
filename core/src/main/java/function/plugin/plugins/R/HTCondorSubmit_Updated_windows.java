...
public class HTCondorSubmit_Updated_windows extends JEXPlugin {

	public static boolean firstTimeCalled = true;

	public HTCondorSubmit_Updated_windows()
	{}
	...
	public boolean run(JEXEntry optionalEntry)
	{
		...
		try {
			...
			if(isInputValid(file2, JEXData.FILE) || isInputValid(file2, JEXData.ROI))
			{
